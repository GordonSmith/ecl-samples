(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "./SpringVizBase"], factory);
    } else {
        root.SpringViz = factory(root.d3, root.SpringVizBase);
    }
}(this, function (d3, SpringVizBase) {
    function SpringViz(target, width, height) {
        SpringVizBase.call(this);
    ...
    SpringViz.prototype = Object.create(SpringVizBase.prototype);

    //  Private  ---
    SpringViz.prototype._update = function () {
        this._updateEdges();
        this._updateVertices();
        this.force.start();
    };

    SpringViz.prototype._updateEdges = function () {
        var context = this;
    ...
    SpringViz.prototype._updateVertices = function () {
        var context = this;
    ...
    //  Meta  ---
    SpringViz.prototype.setVertexMeta = function (meta) {
        this.vertexMeta = meta;
    };

    //  Widget  ---
    SpringViz.prototype.resize = function (width, height) {
    ...
    //  Data  ---
    SpringViz.prototype.setData = function (vertices, edges, append, pos) {
        if (!append) {
    ...
    SpringViz.prototype.removeVertex = function (id) {
    ...
    SpringViz.prototype.highlightVertex = function (d) {
        //  Causes issues in IE  ---
    ...
    SpringViz.prototype.highlightEdge = function (d, self) {
        //  Causes issues in IE  ---
        //  self.parentNode.appendChild(self);
        var zoomScale = this.zoom.scale();
        if (zoomScale > 1)
    ...
    SpringViz.prototype.vertex_mouseover = function (d, self) {
        this.highlightVertex(d, self);
    };

    SpringViz.prototype.vertex_mouseout = function (d, self) {
        this.highlightVertex(null);
    };

    SpringViz.prototype.edge_mouseover = function (d, self) {
        this.highlightEdge(d, self);
    };

    SpringViz.prototype.edge_mouseout = function (d, self) {
