(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "./GMapBase"], factory);
    } else {
        root.GMap = factory(root.d3, root.GMapBase);
    }
}(this, function (d3, GMapBase) {
    ...
    GMap.prototype._updateVertices = function () {
        ...
        ;
        translateVertex.append("svg:circle")
            .attr("class", "circle")
            .attr("r", "1")
            .attr("cx", padding)
            .attr("cy", padding);
        ...
        this.svg.selectAll(".circle")
            ...
            .attr("r", function (d) { return d.first || d.last ? 4.5 : 1; })
        ;
        ...
        function transform(d) {
            ...
            return d3.select(this)
                .attr("transform", "translate(" + [d.geo_x - padding, d.geo_y - padding] + ")")
            ;
        }
    };
